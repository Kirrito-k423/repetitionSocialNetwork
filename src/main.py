...
class DSI(MessagePassing):
    def __init__(self, in_channels, out_channels):
        ...
        self.lin = torch.nn.Linear(in_channels, out_channels, bias=False) # [topicNum*BatchSize,BatchSize]
        self.message_lin = torch.nn.Linear(out_channels, out_channels, bias=False) # W_{ij} 
